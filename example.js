...
// ADD NEW ITEM START OF LIST
var newItemFirst = document.createElement('li');                   // Create element
var newTextFirst = document.createTextNode('Wayne');                // Create text node
newItemFirst.appendChild(newTextFirst);                            // Add text node to element
list.insertBefore(newItemFirst, list.firstChild);                  // Add element to list
...
// Alter item with id="one" class to hot
var colourItem = document.getElementById("one");                   // retreive list element with id of "one"
colourItem.className = 'hot';                                      // change current class attribute of "cool" to class attribute of "red"
